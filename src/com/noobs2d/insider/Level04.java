...
public class Level04 extends LevelScreen {
	...
	background = new DynamicSprite(new TextureRegion(Assets.lvl4, 0, 0, 800, 480), Settings.WIDTH / 2, Settings.HEIGHT / 2);
	background.color.a = 0f;
    }

    @Override
    protected void initRiddles() {
	String clue = "Take away the whole and some still remains. What is it?";
	Riddle donut = new Riddle(clue, new TextureRegion(Assets.lvl4, 231, 480, 51, 33), 205, 90);
	clue = "What burns during the day and sleeps at night?";
	Riddle sun = new Riddle(clue, new TextureRegion(Assets.lvl4, 151, 480, 80, 80), 701, 51);
	clue = "I can run but not walk. whenever I go, thought follows close behind. what am I?";
	Riddle nose = new Riddle(clue, new TextureRegion(Assets.lvl4, 72, 525, 69, 74), 106, 175);
	clue = "I am mother and father, but never birth or nurse. I'm rarely still, but I never wonder. what am I?";
	Riddle tree = new Riddle(clue, new TextureRegion(Assets.lvl4, 72, 480, 60, 45), 748, 429);
	clue = "The man who invented it doesnt want it. The man who bought it doesnt need it. What is it?";
	Riddle coffin = new Riddle(clue, new TextureRegion(Assets.lvl4, 0, 480, 66, 204), 213, 350);

	clue = "I am a box that holds keys without locks, yet they can unlock your soul. What am I?";
	Riddle piano = new Riddle(clue, new TextureRegion(Assets.lvl14, 0, 480, 168, 61), 368, 106);
	clue = "It's red, blue, and purple and green, no one can reach it, not even the queen. What is it?";
	Riddle rainbow = new Riddle(clue, new TextureRegion(Assets.lvl14, 170, 480, 108, 82), 88, 429);
	clue = "A box without hinges, lock or key, yet golden treasure lies within. What is it?";
	Riddle egg = new Riddle(clue, new TextureRegion(Assets.lvl14, 278, 480, 54, 65), 453, 245);
	clue = "A man who always carries his house along with him.";
	Riddle turtle = new Riddle(clue, new TextureRegion(Assets.lvl14, 334, 480, 132, 102), 329, 213);
	clue = "It stands on one leg with its heart in its head.";
	Riddle cabbage = new Riddle(clue, new TextureRegion(Assets.lvl14, 467, 484, 76, 78), 565, 137);
